...
class Model(nn.Module):
    def __init__(self, in_size: int = 1, hid: int = 100, num_layers: int = 1, out_size: int = 1):
        super().__init__()
        self.hidden_size = hid
        self.lstm = nn.LSTM(input_size=in_size, hidden_size=hid, num_layers=num_layers)
    ...
    def fit(self, train_inout_seq, epochs: int = 20, model_name: str = 'Default'):
